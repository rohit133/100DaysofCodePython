...
try:
    ...
    data = pd.read_csv("Day-31\\data\\word_to_learn.csv")
...
def next_card():
    ...
    canvas.itemconfig(card_value, text=current_card["French"], fill="black")
...
card_value = canvas.create_text(400, 263, text="word", font=("Ariel", 60, "bold"))
